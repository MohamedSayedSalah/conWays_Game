...
const flattenedArrayIndexes = compose(flatten, map(head));
...
const exclude = (collection, cell) =>
    collection.filter(complement(elementMatchesCell(cell)));
 ...
 */
export const drawMatrix = curryN(3, (cols, rows, livingCells = {}) =>
